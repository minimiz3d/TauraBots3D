...
public class KeyframeMotion {
  ...
  private static KeyframeSequence DIVE_LEFT;
  private static KeyframeSequence DIVE_RIGHT;
//  private static KeyframeSequence ACABAMOS_DE_CRIAR_ESTE_MOVIMENTO;
  ...
  public KeyframeMotion(EffectorOutput effOut, PerceptorInput percIn, Logger logger) {
    ...
    DIVE_LEFT = keyframeReader.getSequenceFromFile("fall_left.txt");
    DIVE_RIGHT = keyframeReader.getSequenceFromFile("fall_right.txt");
  ...
  public void setStopWalking_Plovdiv2014() {
     ...
     * Tomislav Šubić.
     */
     public void setDive_Left() {
         if (loggingOn) log.log("Left dive.\n");
         actualSequence = DIVE_LEFT;
         state = MotionState.BETWEEN_FRAMES;
     }
     public void setDive_Right() {
         if (loggingOn) log.log("Left dive.\n");
         actualSequence = DIVE_RIGHT;
         state = MotionState.BETWEEN_FRAMES;
     }
