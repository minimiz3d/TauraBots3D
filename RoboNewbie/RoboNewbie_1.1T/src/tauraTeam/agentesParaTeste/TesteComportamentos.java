...
package tauraTeam.agentesParaTeste;
...
import tauraTeam.comportamentos.SoccerTeamThinking;
 ...
 *
 */
public class TesteComportamentos {
    // Função que executa o programa
    public static void main(String args[]) {
        TesteComportamentos agent = new TesteComportamentos();
    ...
    */
    ...
    final String team = "TauraTestes";

    // TESTANDO
    final double beamX = BeamPoses.getX(id_int);
    final double beamY = BeamPoses.getY(id_int);
    final double beamRot = BeamPoses.getRot(id_int);
    ...
    // TODO: Criar lista de posições iniciais no eixo x.

    // Goleiro
    // final double beamX =    -25;
    ...
    */
    private void run(){
        int agentRunTimeInSeconds = 9000;
        ...
        for (int i = 0; i < totalServerCycles; i++) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(TesteComportamentos.class.getName()).log(Level.SEVERE, null, ex);
            }
