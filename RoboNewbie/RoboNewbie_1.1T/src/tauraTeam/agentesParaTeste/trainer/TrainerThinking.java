...
//                startExperiment2();        // with goalkeeper
    ...
    private void startExperiment2() {
        ...
        trainer.moveRotatePlayer(TrainerCommandExecutor.Team.RIGHT, 1, -22.5f, 0f, 0.375f, -90f);
    ...
    private void startExperiment3() {
        ...
        trainer.beamBall(x0, y0, .05f, vx, vy, vz);
        trainer.moveRotatePlayer(TrainerCommandExecutor.Team.RIGHT, 1, -22.5f, -2f, 0.375f, -90f);
    }
